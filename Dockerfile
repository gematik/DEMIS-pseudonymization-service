...
COPY --chown=$USERID:$GROUPID ./target/pseudonymization-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="DEMIS Pseudonymization-Service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/pseudonymization-service" \
