...
/**
 * Defines the configuration for the generation of secrets "one" (used for non-§7.3 Pseudonyms).
 *
 ...
 */
@Validated
@ConfigurationProperties(prefix = "secrets.one.generation")
public record SecretOneGenerationConfiguration(
    boolean enabled,
    boolean initOnMissing,
    @Min(1) @Max(90) int daysOfValidity,
    @Min(1) @Max(50) int secretLength,
