...
*/}}
{{- define "pseudonymization-service-istio.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "pseudonymization-service-istio.fullversionname" -}}
...
*/}}
{{- define "pseudonymization-service-istio.chart" -}}
...
Common labels
*/}}
{{- define "pseudonymization-service-istio.labels" -}}
helm.sh/chart: {{ include "pseudonymization-service-istio.chart" . }}
{{ include "pseudonymization-service-istio.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pseudonymization-service-istio.selectorLabels" -}}
app: {{ .Values.fullName }}
{{- end }}
